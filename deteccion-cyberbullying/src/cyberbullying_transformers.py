...
def run_pipeline(model_type, csv_path, text_col, label_col, model_dir_base="./modelos_transformers", use_saved=True, output_image_dir="."):
    ...
    plt.title(f'Matriz de Confusión Normalizada - {model_name_friendly}')
    plt.xlabel('Predicción')
    plt.ylabel('Realidad')
    plt.savefig(os.path.join(output_image_dir, f"confusion_matrix_normalized_{model_type}.png"))
    plt.close()
