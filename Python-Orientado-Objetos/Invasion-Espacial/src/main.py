...
img_jugador = pygame.image.load("tractores.png")
jugador_x = 368
jugador_y = 500
jugador_x_cambio = 0
...
for e in range(cantidad_enemigos):
    img_enemigo.append(pygame.image.load("trump.png"))
...
img_bala = pygame.image.load("pajita.png")
bala_x = 0
bala_y = 500
bala_x_cambio = 0
bala_y_cambio = 5
...
fuente_final = pygame.font.Font('begokv15__2015___free.otf', 40)
